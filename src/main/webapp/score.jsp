...
String tbl="<table align='center' border=1><tr><th colspan=6> Online Quiz Score </th></tr><tr><th>id</th><th>username</th><th>user_type</th><th>total_attempted</th><th>score</th><th>Status</th></tr>";
while(rs.next()){
	int uid=rs.getInt(1);
	...
	tbl=tbl+"<tr><td>"+uid+"</td><td>"+username+"</td><td>"+user_type+"</td><td>"+total_attempted+"</td><td>"+score+"</td><td>"+exam_status+"</td></tr>";
